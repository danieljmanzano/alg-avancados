# código que usei para começar a entender e resolver o problema
# não é o ideal (não usa dp, então não roda casos grandes), mas achei legal deixar aqui pra mostrar mais ou menos o caminho que tomei pra chegar no "correto"
# a lógica com dp é basicamente isso, mas aplicando memoização
...
def main():
    ...
    for _ in range(casos_teste):
        ...
        pontuacao_jogador_1 = resolver_forca_bruta(pedras, 0, n_pedras - 1, somas_prefixas)
